...
public class FileUtils {
   ...
   * 手机的缓存根目录
   */
  public static String sDataRootPath = App.getApplication().getCacheDir().getPath();
  ...
  public static String getCacheRootDirectory() {
    ...
    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
      return App.getApplication().getExternalCacheDir().getAbsolutePath();
    } else {
      return App.getApplication().getCacheDir().getAbsolutePath();
    }
  }
