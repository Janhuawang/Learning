...
public class LameUtil {
     ...
     * @param inChannel     number of recorder.plugin.channels in input stream.
     ...
     */
    public native static void init(int inSamplerate, int inChannel, int inBitrate,
     ...
     * @param sambles  number of samples per channel. int nsamples = numBytes * 8/(fileFormat.mBitsPerChannel * channel);
