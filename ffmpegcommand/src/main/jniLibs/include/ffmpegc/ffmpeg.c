...
int ffmpeg_main(int argc, char **argv) {
    ...
    if (ret < 0)
        av_log(NULL, AV_LOG_FATAL, " ffmpeg_parse_options < 0\n");
//        exit_program(1);
...
//         exit_program(1);
    ...
    if (transcode() < 0)
        av_log(NULL, AV_LOG_FATAL, " transcode < 0\n");
//        exit_program(1);
    ...
    if ((decode_error_stat[0] + decode_error_stat[1]) * max_error_rate < decode_error_stat[1])
        av_log(NULL, AV_LOG_FATAL, "exit_program(69) \n");
//        exit_program(69);
//    exit_program(received_nb_signals ? 255 : main_return_code);

    if (received_nb_signals == 255) {
        av_log(NULL, AV_LOG_FATAL, "exit_program(255) \n");
    } else {
