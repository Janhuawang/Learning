...
/**
 * com_frank_ffmpeglib_FFPlayer
 * @param env 
 * @param type 
 * @return 
 */
JNIEXPORT jstring JNICALL
Java_com_frank_ffmpeglib_FFPlayer_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_frank_ffmpeglib_FFPlayer_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_frank_ffmpeglib_FFPlayer_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_frank_ffmpeglib_FFPlayer_avFilterInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
Java_com_frank_ffmpeglib_FFPlayer_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                            jobject surface) {
